...
-   Has successfully brought alignment among technological and business stakeholders to scale out data frameworks for delivering enterprise solutions while enforcing governance standards for maintaining data quality and usability.

-   Launched business cases, secured funding and resources, and kick-started momentum by creating processes and project scope that supports rapid iteration on early-stage solutions.

-   A driven mobilizer who can build effective relationships from the C-suite down to transform vision into actionable road maps and well-formed KPIs.
